...
class CafeForm(FlaskForm):
    ...
    location_url = StringField("Cafe Location in Google Maps(URL)", validators=[URL(), DataRequired()])
...
def cafes():
    ...
    with open('cafe-data.csv', newline='', encoding="utf8") as csv_file:
        ...
        titles = list_of_rows.pop(0)

        print(list_of_rows)

    return render_template('cafes.html', cafes=list_of_rows, titles=titles)
